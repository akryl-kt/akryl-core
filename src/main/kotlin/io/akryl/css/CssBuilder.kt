...
class CssBuilder {
  ...
  val flex get() = StringScope(properties, "flex")
  val flexBasis get() = StringScope(properties, "flexBasis")
  val flexDirection get() = StringScope(properties, "flexDirection")
  val flexFlow get() = StringScope(properties, "flexFlow")
  val flexGrow get() = StringScope(properties, "flexGrow")
  val flexShrink get() = StringScope(properties, "flexShrink")
  val flexWrap get() = StringScope(properties, "flexWrap")
